...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Editar marca</title>
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Modificar datos de marca</div>
                    </div>
...
<input id="leavetype" type="text"  class="validate" autocomplete="off" name="leavetype" value="<?php echo htmlentities($result->LeaveType);?>"  required>
                                                <label for="leavetype">Marca</label>
                                            </div>
...
<div class="input-field col s12">
<button type="submit" name="update" class="waves-effect waves-light btn indigo m-b-xs">Actualizar
</button>
