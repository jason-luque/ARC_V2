...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Agregar nuevo usuario</title>
...
error:function (){}
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Agregar nuevo usuario</div>
                    </div>
...
<label for="empcode">Código de empleado (ID debe ser único)</label>
...
<div class="input-field col s12">
<label for="email">Corro electrónico</label>
...
<div class="input-field col s12">
<button type="submit" name="add" onclick="return valid();" id="add" class="waves-effect waves-light btn indigo m-b-xs">Añadir</button>
