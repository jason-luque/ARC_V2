...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Detalles de marca</title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="font-size:24px;">INFORMACIÓN GENERAL</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">DETALLES DE LA MARCA</span>
...
{         
      ?>  
                                        ...
                                        <tr>
                                            <td style="font-size:16px;"> <b>Nombre del usuario:</b></td>
                                          ...
                                          <tr>
                                             <td style="font-size:16px;"><b>ID Emp correo electrónico:</b></td>
                                            <td><?php echo htmlentities($result->EmailId);?></td>
                                             <td style="font-size:16px;"><b>No. Emp Contacto  :</b></td>
  ...
  <tr>
                                             <td style="font-size:16px;"><b>Marca:</b></td>
                                            <td><?php echo htmlentities($result->LeaveType);?></td>
                                             <td style="font-size:16px;"><b>Fecha inicio: </b></td>
                                            <td>From <?php echo htmlentities($result->FromDate);?> to <?php echo htmlentities($result->ToDate);?></td>
                                            <td style="font-size:16px;"><b>Fecha fin: </b></td>
                                           <td><?php echo htmlentities($result->PostingDate);?></td>
                                        </tr>

<tr>
                                             <td style="font-size:16px;"><b>Descripción de la marca del usuario:</b></td>
