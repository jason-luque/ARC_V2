...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Restablecer contraseña |  arc501le </title>
...
<!--
body {
    background-image: url( images/portadacolecollection.jpg);
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title"> ARC | arc501le.com | Recuperar contraseña</span>
                        </div>
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    <li>&nbsp;</li>
                    <li class="no-padding"><a class="waves-effect waves-grey" href="index.php"><i class="material-icons">account_box</i>Inicio de sesión usuario</a></li>
                    <li class="no-padding"><a class="waves-effect waves-grey" href="forgot-password.php"><i class="material-icons">account_box</i>Recuperar contraseña</a></li>
                       ...
                       <li class="no-padding"><a class="waves-effect waves-grey" href="admin/"><i class="material-icons">account_box</i>Inicio de sesión Admin</a></li>
                          ...
                          <div class="col s12 m6 l8 offset-l2 offset-m3">
                              <div class="card white darken-1">
                                  ...
                                  <div class="card-content ">
                                      <span class="card-title" style="font-size:20px;">Detalles sobre el usuario</span>
                                       ...
                                       <div class="row">
                                           <form class="col s12" name="signin" method="post">
                                               <div class="input-field col s12">
                                                   ...
                                                   <label for="email">Ingrese su ID usuario</label>
                                               </div>
                                               <div class="input-field col s12">
                                               ...
                                               <div class="col s12 right-align m-t-sm">
                                                   ...
                                                   <input type="submit" name="submit" value="Enviar" class="waves-effect waves-light btn teal">
                                               </div>
                                           </form>
                                      </div>
                                  </div>
...
foreach ($results as $result) {
 ...
 <div class="row">
          <span class="card-title" style="font-size:30px;">Cambie su contraseña</span>                                     
...
<div class="input-field col s12">
<button type="submit" name="change" class="waves-effect waves-light btn indigo m-b-xs" onclick="return valid();">Confirmar</button>
